...
>> Названия столбцов должны начинаться только с символов латинского алфавита или арабских цифр. Двойные кавычки допускаются. В остальном, 
следует учитывать иное при установке параметра `parameter` и в этом случае пропускать иные символы.
